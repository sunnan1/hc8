  ...
  <head>
	...
	<script>
		...
		function sendPart(m) {
			...
			if( isSet(nativeObj.Func) ) return nativeObj.Func(m);
	...
	<style>
		...
		#parts > div[id]:not([id=""]) { box-sizing:border-box; position:relative; display:block; }
		#parts > div[id]:not([id=""]) { background-size:contain; background-repeat:no-repeat; }
		#front { background-image:url('ui/kits/decubitus/front.svg'); width:93px; height:360px; float:left; clear:both; margin:0 auto; }
